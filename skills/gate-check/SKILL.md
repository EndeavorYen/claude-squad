...
| Gate Level | After PLAN | After EXECUTE | After VERIFY |
|------------|-----------|---------------|--------------|
| **supervised** | Pause | Pause | Pause |
| **standard** | Pause | Proceed | Pause |
| **autonomous** | Proceed | Proceed | Proceed |
...
- **standard** — pause after PLAN (to confirm approach) and after VERIFY (to confirm results), but let EXECUTE run without interruption. This is the recommended default.
