...
**Goal:** Upgrade Squad plugin from v0.1 to v0.2 with INTEGRATE stage, agent output standardization, convoy deployment, and resilience improvements based on real-world mission feedback.
...
4. **Handle failures.** If any teammate reports a failure:
   ...
   - Determine if recoverable (retry, reassign) or requires plan revision
...
5. **Gate check.** When all tasks are complete, invoke the `gate-check` skill:
   - If gate level is `supervised`: pause and present execution summary
...
**Purpose:** Add agent output standardization, interface contracts, and shared file prohibitions to persona templates.

**Files:**
- Modify: `skills/role-forging/SKILL.md`

**Step 1: Add output specification to mandatory persona sections**
...
**Step 2: Add interface contract section**
...
- [ ] Output specification (manifest.md, interface-changes.md, .complete) is included
...
git commit -m "feat: add output standardization, interface contracts to role-forging"
```
...
| Task | File(s) | Priority | Est. Complexity |
|------|---------|----------|-----------------|
| 1 | skills/integration/SKILL.md (new) | P0 | Medium |
| 2 | commands/squad.md (INTEGRATE) | P0 | High |
| 3 | commands/squad.md (convoy EXECUTE) | P1 | Medium |
| 4 | commands/squad.md (VERIFY) | P2 | Medium |
| 5 | commands/squad.md (DEBRIEF) | P1 | Low |
| 6 | commands/squad.md (--abort) | P2 | Low |
| 7 | commands/squad.md (header) | P2 | Trivial |
| 8 | skills/gate-check/SKILL.md | P0 | Medium |
| 9 | skills/mission-planning/SKILL.md | P1 | High |
| 10 | skills/role-forging/SKILL.md | P1 | High |
| 11 | skills/status-report/SKILL.md | P2 | Low |
| 12 | skills/retrospective/SKILL.md | P3 | Medium |
| 13 | config/defaults.yaml | P2 | Low |
| 14 | .claude-plugin/plugin.json | P2 | Trivial |
